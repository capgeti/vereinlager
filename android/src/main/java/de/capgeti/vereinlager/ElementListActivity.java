 ...
 * Date:   05.09.13 23:11
 */
public class ElementListActivity extends ListFragment implements AdapterView.OnItemClickListener {
    ...
    @Override public void onActivityCreated(Bundle savedInstanceState) {
        ...
        adapter = new CustomCursorAdapter(getActivity(), R.layout.element_list_item, elementDataSource.list(categoryId)) {
...
//                besitzer.setText("todo");
    ...
    private void refreshList() {
        Cursor list = elementDataSource.list(categoryId);
    ...
    @Override public void onItemClick(AdapterView<?> adapterView, View view, int i, long id) {
        Fragment fragment = new ElementEditFragment();
        Bundle args = new Bundle();
